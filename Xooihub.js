(() => {
  if (window.__OCQUE_POPUP_UI__) return console.log("⚠️ UI đã tồn tại.");
  ...
  function enableBlocker() {
    ...
    location.assign = function (url) {
      log("🚫 Blocked location.assign:", url);
    };

    location.replace = function (url) {
      log("🚫 Blocked location.replace:", url);
    };
    ...
    document.addEventListener(
      ...
      (e) => {
        ...
        if (a && a.target === "_blank") {
          e.preventDefault();
          log("🚫 Blocked <a target=_blank>:", a.href);
        }
      },
      true
    );

    log("🟢 Popup Blocker ON");
  }
      ...
      <div id="ocque-content">
        ...
        <div id="tab-main">
          <div class="ocque-card">
            <div>
              ...
              <p>Chặn popup / tab mới bằng window.open()</p>
            </div>
          ...
          <div class="ocque-card">
            <div>
              ...
              <p>Chặn tự redirect kiểu assign()</p>
            </div>
          ...
          <div class="ocque-card">
            <div>
              ...
              <p>Chặn thay trang kiểu replace()</p>
            </div>
          ...
          <div class="ocque-card">
            <div>
              ...
              <p>Chặn link mở tab mới qua target blank</p>
            </div>
        ...
        <div id="tab-logs" style="display:none;">
          <div class="ocque-card">
            <div>
              <h3>Console Logs</h3>
              <p>Bật tắt log spam console</p>
            </div>
            <div class="ocque-switch on" data-key="logs"><div class="ocque-dot"></div></div>
          </div>

          <div id="ocque-footer">Made by OcQue. Humans vẫn thích popup, đúng là kỳ lạ.</div>
        </div>
      </div>
    </div>
  `;
  ...
  // Avatar (ảnh hình 2)
  // M lấy link ảnh Hu Tao chibi online hoặc upload github rồi dán vào đây
  const avatarURL =
    "https://anhchibi.com/wp-content/uploads/2024/12/avatar-hutao-chibi.jpg"; // thay link ảnh hình 2 vào đây
  ...
  console.log("✅ OcQue Popup UI Loaded.");
})();
